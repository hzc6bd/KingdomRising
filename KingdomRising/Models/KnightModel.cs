...
namespace KingdomRising
{
	public class KnightModel {
		...
		public KnightModel (CountryModel country, int a, int b, int speed) {
			...
			this.position = KingdomRising.country.locations[a].center;
			this.fX = position.X;
			this.fY = position.Y;
		...
		public void Update (GameTime gameTime) {
			Point a = KingdomRising.country.locations[previous].center;
			Point b = KingdomRising.country.locations[next].center;
